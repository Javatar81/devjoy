...
public class GiteaSpec {
	@JsonPropertyDescription("The configuration of the admin user.")
	...
	@JsonPropertyDescription("The image tag to use for Gitea. Default is 1.23")
	...
	@JsonPropertyDescription("Create a route / ingress to access for Gitea. Default is true.")
	private boolean ingressEnabled = true;
	@JsonPropertyDescription("Enables SSL for Gitea.")
	private boolean ssl;
	@JsonPropertyDescription("Name of the secret containing tls.crt and tls.key.")
	private String tlsSecret;
	@JsonPropertyDescription("The configuration of the Keycloak for using SSO with Gitea.")
